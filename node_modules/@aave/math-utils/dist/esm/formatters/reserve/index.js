...
export function formatReserveUSD({ reserve, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, }) {
    ...
    return Object.assign(Object.assign({}, formattedReserve), { totalLiquidityUSD: nativeToUSD({
        ...
        borrowCapUSD: normalizedToUsd(new BigNumber(reserve.borrowCap), marketReferencePriceInUsd, marketReferenceCurrencyDecimals).toString(), supplyCapUSD: normalizedToUsd(new BigNumber(reserve.supplyCap), marketReferencePriceInUsd, marketReferenceCurrencyDecimals).toString(), unbackedUSD: normalizedToUsd(new BigNumber(reserve.unbacked), marketReferencePriceInUsd, marketReferenceCurrencyDecimals).toString() });
}
